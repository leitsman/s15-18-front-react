...
const page = () => {
  return (
    <main className="w-screen h-screen border-2 border-black border-dashed ">
        <div className="flex flex-row justicefy-center items-center">
            <button className=" gap-2 mx-5 w-12 h-12 bg-gray-100 rounded-full">#</button>
            <div className=" mr-10 text-lg">Perfil</div>
        </div>
            ...
            <div className="mb-80">
                <div className="">
                    <button className="w-60 h-10 bg-gray-200 rounded-lg m-2">
                        <button className="text-xs w-5 h-5 bg-gray-700 rounded-full m-2">!!</button>
                        Privacidad</button>
                </div>
            </div>
