      ...
      <section className='flex flex-col w-screen h-screen gap-6 p-8'>
        <div className='flex justify-between items-center py-1 px-4'>
          <div className='flex items-center'>
            <div className='w-9 h-9 border-2 border-gray-500 bg-gray-500 rounded-full text-[9px] text-white flex justify-center items-center'>Icono</div>
            <h2 className='ml-2 font-sans font-semibold size-5 w-auto'>¡Quiero Reciclar!</h2>
          </div>
        ...
        <div className='flex flex-col mt-3'>
          ...
          <div className='flex flex-col gap-1 mt-2 px-1'>
            <div className='flex justify-between items-center'>
              <h2 className='font-sans font-semibold text-base'>CELULAR</h2>
              <Button variant="outline" className='rounded-3xl bg-gray-200 text-xs px-3 py-0 h-[25px] w-[120px] font-sans font-semibold'>SELECCIONAR</Button>
            </div>
            <h6 className='font-sans font-semibold text-sm tracking-tighter'>20 PUNTOS</h6>
            <h6 className='font-sans font-semibold text-sm tracking-tighter'>Centro de acopio</h6>
            <div className='flex justify-between'>
